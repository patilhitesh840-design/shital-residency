        ...
        <div class="max-w-xl mx-auto glass-panel border border-glass-border-light dark:border-glass-border-dark p-8 rounded-2xl shadow-xl animate-scale-up">
            <div class="flex flex-col items-center gap-3 mb-6 pb-6 border-b border-glass-border-light dark:border-glass-border-dark">
                ...
                <div class="text-center">
                    ...
                    <p class="text-xs text-slate-400">Resident of Building ${user.building}, Flat ${user.flatNo}</p>
                </div>
            </div>
            ...
            <form id="profile-settings-form" class="space-y-4">
                <div class="grid grid-cols-2 gap-4">
                    <div class="space-y-1">
                        ...
                        <input type="text" disabled value="Wing ${user.building}" class="w-full px-3 py-2 rounded-xl glass-input text-xs text-slate-500 bg-slate-900/10 cursor-not-allowed">
                    </div>
                    <div class="space-y-1">
                        <label class="text-[10px] uppercase tracking-wider font-semibold text-slate-400">Flat Number</label>
                        <input type="text" disabled value="Flat ${user.flatNo}" class="w-full px-3 py-2 rounded-xl glass-input text-xs text-slate-500 bg-slate-900/10 cursor-not-allowed">
                    </div>
                </div>
